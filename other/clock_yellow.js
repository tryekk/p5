...
function draw() {
  ...
  fill(93, 149, 239);
  sunr = map(riseSplit, 0, 2359, 0, 360);
  suns = map(setSplit, 0, 2359, 0, 360);
  rotate(-90);
  ...
  stroke(242, 129, 9);
  strokeWeight(j*3);
  angle = map(26.8224*(timerS), 0, 1000, 0, 360);
  rotate(angle);
  line(0, 0, 0, -i*0.32);
  fill(0);
  ellipse(0, 0, j*6, j*6);
